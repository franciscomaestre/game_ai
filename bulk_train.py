...
def bulk_train(agent_params, env_params):
    ...
    agent_params['train_name'] = "base_1_1_sk_4_lr_4_g_93"
    agent_params['learning_rate'] = 1e-4
    agent_params['gamma'] = 0.93
    env_params['skip_rate'] = 4
    train(agent_params, env_params)

    agent_params['train_name'] = "base_1_1_sk_3_lr_4_g_96"
    agent_params['learning_rate'] = 1e-4
    agent_params['gamma'] = 0.96
    env_params['skip_rate'] = 3
    train(agent_params, env_params)

    agent_params['train_name'] = "base_1_1_sk_4_lr_4_g_96"
    agent_params['learning_rate'] = 1e-4
    agent_params['gamma'] = 0.96
    env_params['skip_rate'] = 4
    train(agent_params, env_params)
...
def _make_default_folders(agent_params):
    ...
    if not os.path.isdir(agent_params['output_path']):
        os.makedirs(agent_params['output_path'])
